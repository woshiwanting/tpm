              ...
              <tbody>
                <tr>
                  <td class="text_box_holder">
                    <div id="J-richtext_editor" tabindex="1" autocomplete="off" withplaceholders="true" class="richtext_editor sel_richtext_editor" contenteditable="true"></div>
                  </td>
        ...
        <tr>
          ...
          <td align="right" class="td_extra">
            <span class="form_icon_holder">
              ...
              <img src="/img/img_placeholder.gif" width="22" height="16" class="cmp_priority4 form_action_icon menu_icon">
            </span>
          </td>
        </tr>
      </tbody>
